...
* Population mean
* Movie effect (how much does a rating for the movie, on average, deviate from the population?)
* Mean user/genre effect (how much does a user's rating of a particular genre, averaged over all genres assign to a movie, deviate from the population mean?)

Or mathematically

$$
y_i = µ + b_m_o_v_i_e + b_u_s_e_r_/_g_e_n_r_e
$$
